...
namespace ComplianceMgmt.Api.Controllers
{
    ...
    [Route("[controller]")]
    [ApiController]
    public class BorrowerMortgageOtherController(IBorrowerMortgageOtherRepository repository) : ControllerBase
    {
        [HttpGet("{date}")]
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] BorrowerMortgageOther borrowerMortgageOther)
        {
