...
CREATE /*DEFINER=`a927ee_comlian`@`%`*/ PROCEDURE `spGetIntRateStructure`( 
 p_RepFlag varchar(1), -- R->Rate, S->Slab
 p_ReportDate	date/*,
 OUT p_ErrNo int ,
...
BEGIN
	...
	declare v_Dec1, v_Dec2, v_Dec3, v_Dec4 decimal(15,2);
    ...
    if p_RepFlag = 'R' then
		CREATE TEMPORARY TABLE TempIntRateStructure (
			...
			FixedRateMin  		decimal(6,2),
            FixedRateMax  		decimal(6,2),
            FloatingRateMin  	decimal(6,2),
            FloatingRateMax  	decimal(6,2),
			OrdSeq int
		); 
	else
		CREATE TEMPORARY TABLE TempIntRateStructure (
	...
	if p_RepFlag = 'R' then	-- Rate
		set v_Particulars = 'Retail Prime Lending Rate - Housing';

		select min(Roi), max(Roi) into v_Dec1, v_Dec2
		from stgborrowerloan a
		where a.SanctDate <= p_ReportDate
		and a.LoanPurpose in ('POL-01','POL-02','POL-03','POL-04','POL-05','POL-06')
		and a.IntType = 'TOI-01';

		select min(Roi), max(Roi) into v_Dec3, v_Dec4
		from stgborrowerloan a
		where a.SanctDate <= p_ReportDate
		and a.LoanPurpose in ('POL-01','POL-02','POL-03','POL-04','POL-05','POL-06')
		and a.IntType = 'TOI-02';
        
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq, FixedRateMin, FixedRateMax, FloatingRateMin, FloatingRateMax )
		values ( v_Id, '', v_Particulars, 1, v_Dec1, v_Dec2, v_Dec3, v_Dec4 );
		...
		values ( v_Id, '', v_Particulars, 12, v_Int1, v_Dec1, v_Int2, v_Dec2 );
		...
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq, Fixed_AcctCount, Fixed_OutstandingAmount, Floating_AcctCount, Floating_OutstandingAmount )
		values ( v_Id, '', v_Particulars, 13, v_Int1, v_Dec1, v_Int2, v_Dec2 );
		...
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq, Fixed_AcctCount, Fixed_OutstandingAmount, Floating_AcctCount, Floating_OutstandingAmount )
		values ( v_Id, '', v_Particulars, 14, v_Int1, v_Dec1, v_Int2, v_Dec2 );
		...
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq, Fixed_AcctCount, Fixed_OutstandingAmount, Floating_AcctCount, Floating_OutstandingAmount )
		values ( v_Id, '', v_Particulars, 15, v_Int1, v_Dec1, v_Int2, v_Dec2 );
		...
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq, Fixed_AcctCount, Fixed_OutstandingAmount, Floating_AcctCount, Floating_OutstandingAmount )
		values ( v_Id, '', v_Particulars, 16, v_Int1, v_Dec1, v_Int2, v_Dec2 );
		...
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq, Fixed_AcctCount, Fixed_OutstandingAmount, Floating_AcctCount, Floating_OutstandingAmount )
		values ( v_Id, '', v_Particulars, 17, v_Int1, v_Dec1, v_Int2, v_Dec2 );


		set v_Particulars = 'Non-Housing Loan to Individuals';
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq )
		values ( v_Id, '2', v_Particulars, 18 );
		...
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq, Fixed_AcctCount, Fixed_OutstandingAmount, Floating_AcctCount, Floating_OutstandingAmount )
		values ( v_Id, '', v_Particulars, 19, v_Int1, v_Dec1, v_Int2, v_Dec2 );
		...
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq, Fixed_AcctCount, Fixed_OutstandingAmount, Floating_AcctCount, Floating_OutstandingAmount )
		values ( v_Id, '', v_Particulars, 20, v_Int1, v_Dec1, v_Int2, v_Dec2 );
		...
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq, Fixed_AcctCount, Fixed_OutstandingAmount, Floating_AcctCount, Floating_OutstandingAmount )
		values ( v_Id, '', v_Particulars, 21, v_Int1, v_Dec1, v_Int2, v_Dec2 );
		...
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq, Fixed_AcctCount, Fixed_OutstandingAmount, Floating_AcctCount, Floating_OutstandingAmount )
		values ( v_Id, '', v_Particulars, 22, v_Int1, v_Dec1, v_Int2, v_Dec2 );
		...
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq, Fixed_AcctCount, Fixed_OutstandingAmount, Floating_AcctCount, Floating_OutstandingAmount )
		values ( v_Id, '', v_Particulars, 23, v_Int1, v_Dec1, v_Int2, v_Dec2 );
		...
		SET v_Id = v_Id + 1;
		insert into TempIntRateStructure (Id, SrNo, Particulars, OrdSeq, Fixed_AcctCount, Fixed_OutstandingAmount, Floating_AcctCount, Floating_OutstandingAmount )
		values ( v_Id, '', v_Particulars, 24, v_Int1, v_Dec1, v_Int2, v_Dec2 );
	end if;
